...
const config = {
  ...
  projectName: 'paratextman30', // Usually your repo name.
  ...
  i18n: {
    defaultLocale: 'en',
    locales: ['am', 'ar', 'az', 'bn', 'de', 'es', 'fa', 'ff', 'fr', 'gu', 'ha', 'hi', 'hu', 'id', 'ig', 'km', 'ko', 'ln', 'lo', 'ml', 'my', 'ne', 'nl', 'om', 'or', 'ps', 'pt', 'ro', 'ru', 'sw', 'ta', 'te', 'th', 'tl', 'tpi', 'tr', 'twi', 'uk', 'ur', 'vi', 'yo', 'zh-CN', 'zh-TW'] 
  },
